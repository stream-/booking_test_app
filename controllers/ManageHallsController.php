...
use app\models\HallsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ManageHallsController implements the CRUD actions for Halls model.
 */
class ManageHallsController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    {
        if (($model = Halls::findOne(['id' => $id])) !== null) {
            return $model;
        }
